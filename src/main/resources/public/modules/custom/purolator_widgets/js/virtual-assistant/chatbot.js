...
window.onload = function() {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Express Delivery-DEV-FR');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Express Delivery-PROD-FR');
      }
    } else {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Express Delivery-DEV');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Express Delivery-PROD');
      }
    }
...
function openChatbot(parameter) {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      ...
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Express Delivery-DEV-FR"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Express Delivery-PROD-FR"+param;
      }
    } else {
      dropinTitle = "Puro Virtual Assistant";
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Express Delivery-DEV"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Express Delivery-PROD"+param;
      }
    }
